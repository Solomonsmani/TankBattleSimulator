...
public:
    ...
    {
        std::cout << "Mode: " << (mode == RunMode::COMPARATIVE ? "Comparative" : mode == RunMode::COMPETITION ? "Competition"
                                                                                                              : "Unknown")
                  << "\n";
...
private:
    ...
    std::unique_ptr<UserCommon_318885712_208230862::GameBoard> board;
    ...
    std::unique_ptr<UserCommon_318885712_208230862::GameBoard> createGameBoard(const std::string &mapFile) const;
};
