...
namespace Algorithm_318885712_208230862
{
  ...
  // Constructor
  TankAlgorithm_318885712_208230862::TankAlgorithm_318885712_208230862(int player_index, int tank_index)
  ...
  // Destructor
  TankAlgorithm_318885712_208230862::~TankAlgorithm_318885712_208230862() = default;

  // Updates game state
  void TankAlgorithm_318885712_208230862::updateBattleInfo(BattleInfo &info)
  {
  ...
  queue<ActionRequest> TankAlgorithm_318885712_208230862::getActionsToEnemyTank(Position pos_other)
  {
  ...
  // return next action
  ActionRequest TankAlgorithm_318885712_208230862::getAction()
  {
    turn_num++;
  ...
  bool TankAlgorithm_318885712_208230862::isFree(const Position &pos_other)
  {
  ...
  bool TankAlgorithm_318885712_208230862::isShootPossible()
  {
  ...
  int TankAlgorithm_318885712_208230862::manhattan(const Position &a, const Position &b)
  {
    return abs(a.x - b.x) + abs(a.y - b.y);
  }

  Position TankAlgorithm_318885712_208230862::findClosestEnemyTank()
  {
    int dist = INT_MAX;
  ...
  set<Position> TankAlgorithm_318885712_208230862::computeDangerZones()
  {
...
using Algorithm_318885712_208230862::TankAlgorithm_318885712_208230862;

REGISTER_TANK_ALGORITHM(TankAlgorithm_318885712_208230862)