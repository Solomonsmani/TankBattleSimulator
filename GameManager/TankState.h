...
namespace GameManager_318885712_208230862
{
    ...
    public:
        TankState(int player_idx, int tank_idx, int ammo, UserCommon_318885712_208230862::Position pos);
        ~TankState();

        UserCommon_318885712_208230862::Position getPosition() { return pos; };
        ...
        void setPosition(UserCommon_318885712_208230862::Position p) { pos = p; }
