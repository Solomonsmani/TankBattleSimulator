#include "GameManager_318885712_208230862_A.h"
#include <iostream>
#include <vector>
#include "TankState.h"
...
namespace GameManager_318885712_208230862
{
    ...
    GameManager_318885712_208230862_A::GameManager_318885712_208230862_A(bool verbose)
        : stepCount(0),
          stepsSinceAmmoEnd(0),
          maxSteps(0),
          board(board_),
    ...
    bool GameManager_318885712_208230862_A::isFree(const Position &pos) const
    {
    ...
    void GameManager_318885712_208230862_A::applyActionToTank(TankState &tank, const ActionRequest &action, Player &p)
    {
    ...
    void GameManager_318885712_208230862_A::applyActions(
    ...
    void GameManager_318885712_208230862_A::shellHitWall()
    {
    ...
    void GameManager_318885712_208230862_A::tankHitTank()
    {
    ...
    void GameManager_318885712_208230862_A::shellHitTank()
    {
        std::vector<std::pair<Position, std::string>> survivors;
        survivors.reserve(board.getShells().size());
    ...
    void GameManager_318885712_208230862_A::tankHitMine()
    {
        for (auto &tank : tankStates)
        {
    ...
    void GameManager_318885712_208230862_A::shellHitShell(const std::vector<std::pair<Position, string>> &prevShells)
    {
        map<Position, int> posCount;
    ...
    void GameManager_318885712_208230862_A::advanceStep(Player &p1, Player &p2)
    {
        std::map<std::pair<int, int>, ActionRequest> actions;
    ...
    bool GameManager_318885712_208230862_A::isGameOver() const
    {
    ...
    GameResult GameManager_318885712_208230862_A::run(
    ...
    {
        return std::make_unique<GameManager_318885712_208230862_A>(verbose);
    }
}
using GameManager_318885712_208230862::GameManager_318885712_208230862_A;
REGISTER_GAME_MANAGER(GameManager_318885712_208230862_A)